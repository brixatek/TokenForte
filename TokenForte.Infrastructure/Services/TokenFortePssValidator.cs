...
{
    public class TokenFortePssValidator : ITokenFortePssValidator
    {
        private readonly JwtSecurityTokenHandler _jwtSecurityTokenHandler;

        public TokenFortePssValidator(JwtSecurityTokenHandler jwtSecurityTokenHandler)
        {
            _jwtSecurityTokenHandler = jwtSecurityTokenHandler ?? throw new ArgumentNullException(nameof(jwtSecurityTokenHandler));
        }

        public Task<TokenForteValidationResult> ValidatePssAsync(TokenForteValidationOptions options, string token)
        {
            if (options == null)
